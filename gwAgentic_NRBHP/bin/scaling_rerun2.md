...
The requested `mathcalE < 0.1` target was reached. This is the best result found in this rerun with real linear `alpha(t)` and real linear `beta(t)`, using generic starts rather than previous fitted coefficients.
