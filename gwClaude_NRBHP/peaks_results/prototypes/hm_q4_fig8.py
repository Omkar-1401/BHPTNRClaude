...
T0,T1=creative.NR_T_START,creative.NR_T_END; XCLIP=0.26; Q=4.0
...
with warnings.catch_warnings():
    ...
    ax[2].set_xlabel("t / M")
    fig.suptitle(f"q={Q:g} [in-range]: pn-anchored calibrated vs NR — (2,2),(3,3),(4,4)  (Fig.8-style)")
    fig.tight_layout()
    out=ROOT/"Agentic_plots"/"pn_anchored_hm"; out.mkdir(parents=True,exist_ok=True)
    p=out/"q4_waveforms_224.png"; fig.savefig(p,dpi=130); print(f"saved {p}")
